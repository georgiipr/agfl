...
class SpikingEEGNet(nn.Module):
    def __init__(self, num_channels=44, num_classes=4, samples=1000, 
        ...
        self.temporal_conv = nn.Conv1d(num_channels, num_channels, kernel_size=64, padding=31, groups=num_channels, bias=False)
        self.temporal_pool = nn.AvgPool1d(kernel_size=8, stride=8)
