...
from tests.references.agfl import AGFL
from tests.references.standard_attention import StandardAttention

class EEGNet(nn.Module):
    def __init__(self, num_channels=22, num_classes=4, samples=1000, temp_kernel=32,
    ...
    def _calculate_out_features(self, samples, channels):
        """Safely calculates linear layer input size, accounting for attention blocks."""
        with torch.no_grad():
